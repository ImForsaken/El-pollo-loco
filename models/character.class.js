class Character extends MovableObject {
  ...
  checkIfCharMovesLeft() {
    return (
      !world.gamePaused && keyboard.LEFT && this.x > -100 && this.energy > 0
    );
  }
  ...
  checkIfCharIsHurt() {
    return (
      !world.gamePaused && this.isHurt(this.immortalDuration) && !this.isDead()
    );
  }
  ...
  checkCharLongIdle() {
    return (
      !world.gamePaused &&
      this.characterStartLongIdling(this.longIdle) &&
      this.lastKeyPress > 0 &&
      !this.isDead()
    );
  }
  ...
  checkCharIdle() {
    return (
      !world.gamePaused &&
      this.characterStartIdling(this.startIdle) &&
      !this.isDead()
    );
  }
